        ...
        <div tw="flex-col h-full w-full justify-start">
          ...
          <div tw="flex space-x-4 mt-4">
            <button
              ...
              css={[tw`focus:outline-none focus:ring bg-black text-white hover:bg-gray-200 hover:text-black ring-pink-500 rounded-sm px-5 py-2`]}
            >
              {isPaused ? <Play /> : <Pause />}
            </button>
            ...
            <button
              ...
              css={[tw`focus:outline-none focus:ring bg-black text-white hover:bg-blue-400 ring-pink-500 rounded-sm px-5 py-2`]}
            >
              <RefreshCw />
            </button>
          </div>
