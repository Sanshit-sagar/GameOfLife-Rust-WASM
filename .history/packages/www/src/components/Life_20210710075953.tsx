...
const Life: React.FC = () => {
  ...
  return (
    <div tw="leading-none inline-flex justify-between w-full h-full w-full bg-black">
      <div tw="mb-4">
        ...
        <div tw="flex space-x-4 mt-4">
          <button
            ...
            css={[tw`focus:outline-none px-3 py-1 border border-black focus:ring ring-pink-500 rounded-sm`]}
          >
            {isPaused ? <Play /> : <Pause />}
          </button>
          ...
          <button
            ...
            css={[tw`focus:outline-none focus:ring bg-white hover:bg-blue-400 ring-pink-500 rounded-sm px-5 py-2`]}
          >
            <RefreshCw />
          </button>
        </div>
      ...
      <div tw="container mx-auto p-5 rounded-md bg-black shadow-lg">
        ...
        <li>
          <ul> latest </ul>
          <ul> avg of last 100 </ul>
          <ul> min of last 100 </ul>
          <ul> max of latest 100 </ul> 
        </li>
      </div>
