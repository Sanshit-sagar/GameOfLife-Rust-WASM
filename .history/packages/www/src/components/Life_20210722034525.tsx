...
const DynamicFpsView = dynamic(
  () => import('./FpsView'),
  { ssr: false }
)
const DynamicFpsHistory = dynamic(
  () => import('./FpsHistory'),
  { ssr: false }
)
...
const Life: React.FC = () => {
  ...
  const {fps, avgFps, maxFps, currentFps} = useDynamicFps(100);
      ...
      <div tw="mb-4">
        <div tw="flex-col h-full w-full justify-start">
          ...
          <div tw="container mx-auto p-5 mt-5 rounded-md shadow-lg border border-black">
            ...
            <DynamicFpsView width={240} height={180} bottom={0} right={0}/>
            <DynamicFpsHistory numElements={100} />
            {/* <div>
