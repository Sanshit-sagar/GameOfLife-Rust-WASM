...
const Life: React.FC = () => {
  ...
  return (
    <div tw="leading-none inline-flex justify-between w-full h-full m-5 p-5 border border-black">
      <div tw="mb-4">
      ...
      <div className="container mx-auto p-5 rounded-md bg-black shadow-lg">
