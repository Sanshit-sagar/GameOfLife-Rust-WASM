...
const Life: React.FC = () => {
  ...
  const { fps, avgFps, maxFps, minFps, currentFps, lastFpsValues } = useFps(100);
      ...
      <div tw="mb-4">
        <div tw="flex-col h-full w-full justify-start">
          ...
          <div tw="container mx-auto p-5 mt-5 rounded-md shadow-lg border border-black">
            ...
            <li>
              <ul> Frames per second: {fps} </ul>
              <ul> Avg of last 100: {avgFps} </ul>
              <ul> Max of last 100 {maxFps} </ul>
              <ul> Min of last 100: </ul> 
              <ul> Current FPS {currentFps} </ul> 
            </li>
